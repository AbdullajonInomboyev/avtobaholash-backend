    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Bosh Admin'), ('admin', 'Admin'), ('department_head', 'Kafedra Mudiri'), ('teacher', "O'qituvchi"), ('student', 'Talaba')], default='student', max_length=20)),
                ('is_inclusive', models.BooleanField(default=False, help_text='Ovozli interfeys yoqiladi', verbose_name="Ko'zi ojiz talaba")),
